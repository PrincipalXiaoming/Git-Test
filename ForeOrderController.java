package com.wxm.demo.controller.fore;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.wxm.demo.controller.BaseController;
import com.wxm.demo.entity.*;
import com.wxm.demo.service.*;
import com.wxm.demo.util.OrderUtil;
...
public class ForeOrderController extends BaseController {
    ...
    public String createOrderItem(@PathVariable("productId")Integer productId,
        ...
        productOrderItem.setProductOrderItemPrice(product.getProductSalePrice() * product_number);
    ...
    public String goToOrderConfirmPageByCart(Map<String,Object> map,
        ...
        map.put("districtAddress",districtAddress);
        ...
        map.put("cityAddressId",detailsAddress);
    ...
    public String createOrderByList(HttpSession session,Map<String,Object> map,HttpServletResponse response,
                                    ...
                                    @RequestParam String orderItemJSON) throws UnsupportedEncodingException, UnsupportedEncodingException {
        JSONObject object = new JSONObject();
        logger.info("检查用户是否登录");
        Object userId=checkUser(session);
        if(userId == null){
    ...
    //更新订单信息为交易关闭-ajax
    @ResponseBody
    @RequestMapping(value = "order/close/{order_code}",method = RequestMethod.PUT,produces = "application/json")
    ...
    public String createOrderByOne(HttpSession session,Map<String,Object> map,HttpServletResponse response,
                                   ...
                                   @RequestParam(value = "orderItem_product_id",required = false) Integer orderItemProductId,
                                   @RequestParam(value = "orderItem_number",required = false) Short orderItemNumber
        ...
        productOrderItem.setProductOrderItemUserMessage(userMessage);
